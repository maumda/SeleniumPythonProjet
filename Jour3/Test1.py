...
driver.find_element(By.ID, "FirstName").send_keys("Mauricio")
driver.find_element(By.ID, "LastName").send_keys("Miranda")
driver.find_element(By.ID, "Email").send_keys("maucito12@outlook.com")
driver.find_element(By.ID, "Password").send_keys("F$#f437yf9")
driver.find_element(By.ID, "ConfirmPassword").send_keys("F$#f437yf9")
